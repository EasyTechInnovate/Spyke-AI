                        ...
                        <motion.div
                            ...
                            <button
                                ...
                                <div className="flex items-start gap-4 flex-1">
                                    ...
                                    <h3 className="font-medium text-[#121212] dark:text-[#00FF89] text-left leading-relaxed">
                                        {faq.question}
                                    </h3>
                                </div>
            ...
            {product?.hasGuarantee && product?.guaranteeText && (
                <motion.div
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-medium text-[#121212] dark:text-[#00FF89] mb-2">
            ...
            <motion.div
                ...
                <div className="bg-[#00FF89]/5 dark:bg-[#00FF89]/10 rounded-lg p-6 border border-[#00FF89]/20 dark:border-[#00FF89]/30">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <button className="inline-flex items-center gap-2 px-4 py-2 bg-[#00FF89] hover:bg-[#00FF89]/90 text-[#121212] rounded-lg font-medium transition-colors">
                ...
                <motion.div
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#FFC050]/10 text-[#FFC050] rounded-lg border border-[#FFC050]/30">
                        <span className="text-sm font-medium">
                            Additional premium FAQs available after purchase
                        </span>
                    </div>
                </motion.div>
            )}
