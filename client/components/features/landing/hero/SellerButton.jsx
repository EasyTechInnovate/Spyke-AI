...
const SellerButton = () => {
    ...
    if (!isAuthenticated) {
        return (
            <Link
                ...
                aria-label="Sign up to become a seller - Start earning by selling AI tools and prompts"
            >
                <div className="relative overflow-hidden">
                    ...
                    <button 
                        ...
                        aria-label="Become a seller - Join our platform to start selling AI tools and automations"
                    >
                        <Sparkles className="w-4 h-4 text-[#00FF89]/70 group-hover:text-[#00FF89] transition-colors duration-300 group-hover:rotate-12 group-hover:scale-110" aria-hidden="true" />
                        ...
                        <ArrowRight className="w-4 h-4 group-hover:translate-x-1 group-hover:text-[#00FF89] transition-all duration-300" aria-hidden="true" />
                    </button>
    ...
    if (hasRole('seller')) {
        return (
            <Link
                ...
                className="group w-full sm:w-auto"
                aria-label="Go to seller dashboard - Manage your products and sales"
            >
                <div className="relative overflow-hidden">
                    ...
                    <button 
                        className="relative flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 text-white font-semibold border border-[#00FF89]/30 rounded-lg hover:border-[#00FF89]/60 transition-all duration-300 hover:shadow-lg hover:shadow-[#00FF89]/20 w-full sm:w-auto backdrop-blur-sm min-h-[48px] touch-manipulation"
                        aria-label="Start selling - Go to your seller dashboard"
                    >
                        <Star className="w-4 h-4 text-[#00FF89] group-hover:fill-current group-hover:rotate-12 group-hover:scale-110 transition-all duration-300" aria-hidden="true" />
                        ...
                        <ArrowRight className="w-4 h-4 text-[#00FF89] group-hover:text-white group-hover:translate-x-1 transition-all duration-300" aria-hidden="true" />
                    </button>
                </div>
            </Link>
        )
    ...
    return (
        <Link
            ...
            className="group w-full sm:w-auto"
            aria-label="Learn about seller benefits - Discover how to start selling on our platform"
        >
            <div className="relative overflow-hidden">
                ...
                <button 
                    className="relative flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 text-white font-semibold border border-white/20 rounded-lg hover:border-[#00FF89]/40 transition-all duration-300 hover:shadow-lg hover:shadow-[#00FF89]/10 w-full sm:w-auto backdrop-blur-sm min-h-[48px] touch-manipulation"
                    aria-label="Become a seller - Learn about benefits and get started"
                >
                    <Sparkles className="w-4 h-4 text-amber-400/70 group-hover:text-[#00FF89] transition-all duration-300 group-hover:rotate-12 group-hover:scale-110" aria-hidden="true" />
