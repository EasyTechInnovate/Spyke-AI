                              ...
                              <div>
                                  <div className="px-4 py-3 flex items-center justify-between">
                                      <div className="flex items-center gap-2">
                                          ...
                                          <span className="text-xs text-gray-400 uppercase tracking-wider font-medium">Top Results</span>
                                      </div>
                                          ...
                                          <button
                                              ...
                                              <div className="flex-1 text-left">
                                                  ...
                                                  <div className="flex items-center gap-3 mt-1">
                                                      ...
                                                      <span className="text-sm font-bold text-[#00FF89]">${product.price}</span>
                                                  </div>
                                              </div>
                              ...
                              <div>
                                  <div className="px-4 py-3 flex items-center justify-between">
                                      <div className="flex items-center gap-2">
                                          ...
                                          <span className="text-xs text-gray-400 uppercase tracking-wider font-medium">Recent Searches</span>
                                      </div>
                                      <button
                                      ...
                                      {recentSearches.map((search, index) => (
                                          <div
                                              ...
                                              <button
                                                  ...
                                                  <span className="text-sm text-gray-300 group-hover:text-white transition-colors">{search}</span>
                                              </button>
                                              <button
                                                  onClick={(e) => {
                                                      e.stopPropagation()
                                  ...
                                  <div className="px-4 py-3 border-t border-gray-800">
                                      <p className="text-xs text-gray-500 text-center">Searches are saved locally on your device</p>
                                  </div>
                              </div>
                          )}
                          ...
                          {!searchQuery && recentSearches.length === 0 && (
                              <div className="p-4">
                                  <div className="flex items-center gap-2 mb-3">
                                      ...
                                      <span className="text-xs text-gray-400 uppercase tracking-wider font-medium">Trending Searches</span>
                                  </div>
