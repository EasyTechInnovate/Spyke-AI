      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="hidden lg:flex items-center gap-2 px-4 py-2 bg-gray-900 border border-gray-800 rounded-xl hover:bg-gray-800 transition-colors"
          >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none px-4 py-2 pr-10 bg-gray-900 border border-gray-800 rounded-xl hover:bg-gray-800 transition-colors cursor-pointer"
            >
          ...
          {/* View Mode Toggle */}
          <div className="hidden sm:flex items-center bg-gray-900 border border-gray-800 rounded-xl">
            <button
