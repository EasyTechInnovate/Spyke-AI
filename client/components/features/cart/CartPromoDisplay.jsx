...
import { Tag, Copy, CheckCircle, Clock, Percent, DollarSign, Sparkles } from 'lucide-react'
    ...
    const fetchApplicablePromocodes = async () => {
        try {
            ...
            if (response?.promocodes) {
                ...
                setPromocodes(applicablePromos)
            }
        } catch (error) {
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {!isCurrentlyApplied && (
                                            <button
                                                onClick={() => onApplyPromo(promocode.code)}
                                                disabled={promoLoading}
                                                className="px-3 py-2 bg-[#00FF89] text-black rounded-lg text-xs font-medium hover:bg-[#00FF89]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                                            >
