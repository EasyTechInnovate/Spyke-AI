        ...
        return products.filter(product => {
            ...
            if (filters.priceRange !== 'all') {
                ...
                switch (filters.priceRange) {
                    ...
                    case 'under-20': return price > 0 && price < 20
    ...
    if (products.length === 0) {
        return (
            <div className="text-center py-16">
                ...
                <h3 className="text-xl text-[#FFFFFF] mb-2" style={{ fontFamily: 'var(--font-league-spartan)', fontWeight: '600' }}>No Products Yet</h3>
                            ...
                            <button
                                ...
                                className={`p-4 transition-all duration-300 ${
                                    viewMode === 'grid' 
                                        ...
                                        : 'bg-[#121212] text-[#6b7280] hover:text-[#FFFFFF]'
                                }`}
                            >
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    >
                                        <option value="all" className="bg-[#121212]">All Prices</option>
                                        <option value="free" className="bg-[#121212]">Free</option>
                                        <option value="under-20" className="bg-[#121212]">Under $20</option>
                                        <option value="20-50" className="bg-[#121212]">$20 - $50</option>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="automation" className="bg-[#121212]">Automation</option>
                                        <option value="prompt" className="bg-[#121212]">AI Prompt</option>
                                        <option value="agent" className="bg-[#121212]">AI Agent</option>
    ...
    return (
        <div className={`relative ${className}`} ref={triggerRef} style={{ minWidth }}>
            <button
                ...
                <svg className="w-4 h-4 ml-2 text-[#9ca3af]" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex-1 min-w-0">
                                <h3 className="text-[#FFFFFF] text-lg line-clamp-1 mb-2" style={{ fontFamily: 'var(--font-league-spartan)', fontWeight: 'bold' }}>
                                    {product.title}
                                </h3>
                            ...
                            <div className="text-right">
                                ...
                                {product.originalPrice && product.originalPrice > product.price && (
                                    <div className="text-sm text-[#6b7280] line-through font-[var(--font-kumbh-sans)]">
                ...
                <div className={`absolute inset-0 bg-[#121212]/60 flex items-center justify-center gap-3 transition-all duration-300 ${
                    ...
                    <motion.button 
                        ...
                        className={`p-3 backdrop-blur-sm rounded-full transition-all touch-target ${
                            isLiked 
                                ? 'bg-red-400/80 text-[#FFFFFF]' 
                                : 'bg-[#FFFFFF]/20 text-[#FFFFFF] hover:bg-red-400/30'
                        }`}
                        tabIndex={0}
