...
export default function EditProductPage() {
    ...
    const handlePremiumContentArrayChange = (field, index, newValue) => {
        setFormData((prev) => ({
            ...prev,
            premiumContent: {
                ...prev.premiumContent,
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => handlePremiumContentChange('promptText', e.target.value)}
                                    rows={4}
                                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white resize-none focus:outline-none focus:border-brand-primary"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => handlePremiumContentChange('automationInstructions', e.target.value)}
                                    rows={4}
                                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white resize-none focus:outline-none focus:border-brand-primary"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => handlePremiumContentChange('agentConfiguration', e.target.value)}
                                    rows={4}
                                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white resize-none focus:outline-none focus:border-brand-primary"
                                ...
                                <div className="space-y-3">
                                    {formData.premiumContent.detailedHowItWorks.map((step, i) => (
                                        <div
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => removePremiumContentArrayItem('detailedHowItWorks', i)}
                                    ...
                                    {formData.premiumContent.videoTutorials.map((video, i) => (
                                        <div
                                            ...
                                            <div className="flex items-center justify-between mb-3">
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => removePremiumContentArrayItem('videoTutorials', i)}
                                                    className="p-1.5 text-red-400 hover:bg-red-400/10 rounded-lg transition-colors">
                                                    <X className="w-4 h-4" />
                                                </button>
                                            </div>
