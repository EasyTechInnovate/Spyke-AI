  ...
  return (
    <div className="space-y-10">
      ...
      <motion.div
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <Tooltip content={FIELD_HELP.toolsUsed} examples={FIELD_HELP.toolsUsed.examples} />
          </div>
      ...
      <motion.div
        ...
        className="space-y-3">
        <div className="flex items-center space-x-2">
          <label htmlFor="toolsConfiguration" className="block text-lg font-semibold text-white">
            Overall Integration Description *
          </label>
          <Tooltip content={FIELD_HELP.toolsConfiguration} examples={FIELD_HELP.toolsConfiguration.examples} />
        </div>
        ...
        <textarea
          ...
          rows={5}
          className={`w-full px-5 py-4 text-lg bg-gray-800 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 transition-all resize-none ${showError('toolsConfiguration')
        ...
        {showError('toolsConfiguration') && (
          <div className="text-base text-red-400">
            {getEnhancedErrorMessage('toolsConfiguration', errors.toolsConfiguration)}
          </div>
        )}
      </motion.div>
      ...
      <motion.div
        ...
        <div className="flex items-center space-x-2">
          ...
          <Tooltip content={FIELD_HELP.setupTimeEstimate} examples={FIELD_HELP.setupTimeEstimate.examples} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {SETUP_TIMES.map((time) => (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`p-5 rounded-lg border-2 text-left transition-all ${setupTimeEstimate === time.value
        ...
        {showError('setupTimeEstimate') && (
          <div className="text-base text-red-400">
            {getEnhancedErrorMessage('setupTimeEstimate', errors.setupTimeEstimate)}
          </div>
        )}
      </motion.div>
