...
import { ArrowRight, Shield, Globe, CheckCircle, Zap, Users, Target, Lightbulb, Star, Award, Linkedin } from 'lucide-react'
import Link from 'next/link'
import Image from 'next/image'
import sriPhoto from '@/Sri.jpeg'
    ...
    const teamMembers = [
        {
            ...
            linkedin: 'https://www.linkedin.com/in/srikanishka/',
            image: sriPhoto
        }
    ]
    return (
                ...
                <Container>
                    <motion.div
                        ...
                        <motion.h1
                            ...
                            Empowering the Future of <span className="text-[#00FF89]">AI Innovation</span>
                        </motion.h1>
                        <motion.p
                            variants={fadeInUp}
                            className="text-xl md:text-2xl text-gray-300 leading-relaxed mb-12 max-w-3xl mx-auto">
                            SpykeAI is where creators, developers, and businesses connect to exchange AI-powered tools, prompts, automation workflows,
                            and services — all in one trusted marketplace.
                        </motion.p>
                        <motion.div
                            variants={fadeInUp}
                ...
                <Container>
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-league-spartan">Our Story</h2>
                        </motion.div>
                        <motion.div
                            variants={fadeInUp}
                            className="bg-[#1f1f1f] rounded-2xl p-8 md:p-12 border border-gray-800">
                            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6">
                                Founded in 2025, SpykeAI was built to bridge the gap between AI creators and those who need AI-powered solutions. We
                                noticed a growing demand for high-quality AI models, prompts, and automation tools — and a lack of a centralised,
                                secure marketplace where these could be exchanged with confidence.
                            </p>
                            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                                What started as a simple idea has evolved into a comprehensive platform where innovation meets opportunity, connecting
                                talented AI creators with businesses and individuals seeking cutting-edge solutions.
                            </p>
                        </motion.div>
                    </motion.div>
                </Container>
                        ...
                        <motion.div
                            ...
                            <div className="relative bg-[#1f1f1f] rounded-2xl p-8 md:p-12 border border-[#00FF89]/20">
                                <p className="text-xl md:text-2xl text-white leading-relaxed font-medium">
                                    To make AI innovation accessible, secure, and profitable for creators while empowering businesses and individuals
                                    with tools that accelerate their success.
                                </p>
                            </div>
                        </motion.div>
                    </motion.div>
                ...
                <Container>
                    <motion.div
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-league-spartan">What We Offer</h2>
                            ...
                            {offerings.map((offering, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        <h3 className="text-xl font-semibold text-white mb-3 font-league-spartan">{offering.title}</h3>
                ...
                <Container>
                    <motion.div
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-league-spartan">Why Choose SpykeAI</h2>
                            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                                ...
                                return (
                                    <motion.div
                                        ...
                                        <div className="flex items-start gap-6">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-semibold text-white mb-3 font-league-spartan">{feature.title}</h3>
                ...
                <Container>
                    <motion.div
                        ...
                        <motion.div
                            ...
                            className="bg-[#1f1f1f] rounded-2xl p-8 md:p-12 border border-gray-800">
                            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                                We envision SpykeAI as the go-to global hub for AI innovation, where every creator has the tools to monetise their
                                expertise, and every buyer can find reliable AI solutions — all in one place. Together, we're building the future of
                                AI commerce.
                            </p>
                        </motion.div>
                    </motion.div>
                ...
                <Container>
                    <motion.div
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-league-spartan">Meet Our Team</h2>
                            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                                    ...
                                    <motion.div
                                        ...
                                        {member.image ? (
                                            <Image
                                                ...
                                                width={128}
                                                height={128}
                                                className="w-32 h-32 rounded-full object-cover ring-2 ring-[#00FF89]/40 mx-auto mb-6"
                                                priority
                                            />
                                        ) : (
                                            <div className="w-32 h-32 bg-gradient-to-br from-[#00FF89]/20 to-[#00FF89]/5 rounded-full mx-auto mb-6 flex items-center justify-center group-hover:from-[#00FF89]/30 group-hover:to-[#00FF89]/10 transition-all">
                                                <Users className="w-12 h-12 text-[#00FF89]" />
                                            </div>
                                        )}
                                        <h3 className="text-lg font-semibold text-white mb-1 font-league-spartan">{member.name}</h3>
                                        <p className="text-[#00FF89] font-medium mb-3 text-sm">{member.role}</p>
                                        ...
                                        {member.linkedin && (
                                            <div className="mt-4">
                                                <Link
                                                    ...
                                                    className="inline-flex items-center gap-2 text-[#00FF89] hover:text-[#00FF89]/80 text-sm font-medium"
                                    ...
                                    <motion.div
                                        ...
                                        {member.image ? (
                                            <Image
                                                ...
                                                width={96}
                                                height={96}
                                                className="w-24 h-24 rounded-full object-cover ring-2 ring-[#00FF89]/40 mx-auto mb-6"
                                                priority
                                            />
                                        ) : (
                ...
                <Container>
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <div className="relative bg-[#1f1f1f] rounded-2xl p-8 md:p-12 border border-[#00FF89]/20">
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-league-spartan">Join Us</h2>
                                <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8">
                                    Whether you're an AI creator ready to showcase your work or a business looking for cutting-edge solutions, SpykeAI
                                    is your trusted partner in the AI revolution.
                                </p>
