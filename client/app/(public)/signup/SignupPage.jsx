                            ...
                            <div className="hidden lg:block space-y-4 xl:space-y-6 pr-4 xl:pr-8">
                                <div className="space-y-3 sm:space-y-4">
                                    ...
                                    <p className="text-base xl:text-lg text-gray-300 leading-relaxed pr-4 font-semibold">
                                        Create your account in seconds and unlock the world's largest AI marketplace. Connect with creators, discover
                                        premium tools, and scale your business.
                                    </p>
                                </div>
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            <ChevronDown
                                                                className={`w-3 h-3 transition-transform flex-shrink-0 ${showCountryDropdown ? 'rotate-180' : ''}`}
                                                            />
                                                        </button>
                                            ...
                                            <div className="space-y-2.5 pt-1">
                                                <label className="flex items-start gap-2 cursor-pointer group">
                                                    ...
                                                    <span className="text-xs text-gray-300 group-hover:text-white transition-colors leading-relaxed font-medium">
                                                        ...
                                                        <Link
                                                            href="/terms"
                                                            className="text-[#00FF89] hover:underline font-bold">
                                                            Terms of Service
                                                        </Link>{' '}
                                                        and{' '}
                                                        <Link
