...
export default function RefundPolicyPage() {
    ...
    const refundExceptions = [
        ...
        },
        {
            ...
            description: "If the file provided is damaged, incomplete, or cannot be used as described, and the Seller cannot provide a working replacement."
        },
        {
                    ...
                    >
                        <div className="prose prose-lg prose-invert max-w-none">
                            ...
                            <motion.div variants={fadeInUp} className="mb-12">
                                <h2 className="text-2xl font-bold text-[#00FF89] mb-6 font-league-spartan">1. General Policy for Digital Products & Services</h2>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-300">
                                                All sales of digital products, AI models, prompts, automation workflows, AI Agents, and services are <strong className="text-white">final</strong>.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Section 2 */}
                            <motion.div variants={fadeInUp} className="mb-12">
                                <h2 className="text-2xl font-bold text-[#00FF89] mb-6 font-league-spartan">2. Exceptions Where Refunds May Be Considered</h2>
                                <div className="space-y-4 text-gray-300 mb-6">
                                    <p>Refunds may be granted only in the following cases:</p>
                                </div>
                                <div className="grid gap-4">
                                    {refundExceptions.map((exception, index) => (
                                        <div key={index} className="bg-[#1f1f1f] rounded-xl p-6 border border-green-500/20 hover:border-green-500/30 transition-colors">
                                            <div className="flex items-start gap-4">
                            ...
                            <motion.div variants={fadeInUp} className="mb-12">
                                ...
                                <div className="space-y-6 text-gray-300">
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <ul className="list-disc list-inside space-y-1 ml-4 text-gray-300">
                                                        ...
                                                        <li>Detailed description of the issue, along with any supporting evidence (Screenshots, Recordings of Errors or any bugs faced)</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="space-y-4">
                                        <p>SpykeAI will investigate refund requests in detail after the Buyer provides sufficient proof or evidence.</p>
                                        <p>Refunds, if approved, will be processed to your original payment method within <strong className="text-white">7–10 business days</strong>.</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <motion.div variants={fadeInUp} className="mb-12">
                                ...
                                <div className="space-y-4 text-gray-300">
                                    <ul className="list-disc list-inside space-y-3 ml-4">
                                        ...
                                        <li>Sellers are required to cooperate with refund investigations. Failure to do so may result in account suspension, withholding of payments, or permanent removal from the Platform.</li>
                                        <li>Sellers are responsible for presenting accurate information during onboarding and in product listings.</li>
                                    </ul>
                                </div>
                            </motion.div>
                            ...
                            <motion.div variants={fadeInUp} className="mb-12">
                                ...
                                <div className="space-y-4 text-gray-300">
                                    <ul className="list-disc list-inside space-y-3 ml-4">
                                        <li>If refund-related issues arise with a Seller, SpykeAI reserves the right to temporarily stop any pending payments to that Seller.</li>
                                        <li>SpykeAI will investigate the issue thoroughly, and if any discrepancies or violations are found, no commissions will be paid on the affected transactions.</li>
                            ...
                            <motion.div variants={fadeInUp} className="mb-12">
                                ...
                                <div className="space-y-4 text-gray-300">
                                    <p>
                                        We may update this policy at any time. Updates will be posted on this page with a new "Effective Date."
                                    </p>
                                </div>
                            </motion.div>
