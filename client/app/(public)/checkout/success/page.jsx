                    ...
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <motion.div
                            ...
                            {orderId && (
                                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 mb-8">
                                    ...
                                    {isManualPayment && <p className="text-xs text-brand-primary mt-2">Test Mode - Manual Payment</p>}
                                </div>
                            )}
                        ...
                        <motion.div
                            ...
                            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
                                ...
                                <p className="text-sm text-gray-400">We've sent you a confirmation with your order details and access instructions</p>
                            </div>
                            ...
                            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
                                ...
                                <p className="text-sm text-gray-400">Visit your purchases page to download and access your new AI tools</p>
                            </div>
                            ...
                            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
                                ...
                                <p className="text-sm text-gray-400">Our support team is here to help you get started with your new tools</p>
                            </div>
                        </motion.div>
                    </div>
                </Container>
